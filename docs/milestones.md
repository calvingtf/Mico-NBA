...
The full history, kept because the numbers in it are the argument. The README
summarises; this is the evidence, milestone by milestone, including the results
that did not go the way the design predicted.
